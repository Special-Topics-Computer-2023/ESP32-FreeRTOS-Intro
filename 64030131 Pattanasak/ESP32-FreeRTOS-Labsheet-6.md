...
![](./64030131%20Pattanasak/Pictures/Result/Lab6.png)

* ผลลัพธ์ การจัดการอินเตอรัพอร์ต เมื่อปุ่มถูกกด และจัดการอินเตอรัพอร์ตนี้ในงานที่แยกต่างหาก interrupt_task ซึ่งทำให้ LED สว่างหรือดับขึ้นตามสถานะของปุ่ม.
